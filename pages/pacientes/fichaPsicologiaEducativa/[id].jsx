...
import { fichaPsicologiaEducativaActualizar, fichaPsicologiaEducativaById, pacienteById, psicologiaEducativaPDF } from '@/utils/apiRequests';
const { Option } = Select;
    ...
    return (
        <MenuWrapper setLang={true}>
            ...
            <Card>
                ...
                <Form form={form} disabled={!user?.permisos?.psicologiaEducativa} layout="vertical" onFinish={onFinish}>
